...
<div class="col-sm-8">
	...
	<div class="kboard-header">
		<div class="kboard-map-v2">
			...
			<div class="map-area" style="left:20%;top:16%;" data-map="https://www.cosmosfarm.com/demo/wp-content/plugins/kboard/skin/ocean-franchise/images/map-v2-seoul.png"><a href="<%=path%>/board_list.nanum">서울</a></div>

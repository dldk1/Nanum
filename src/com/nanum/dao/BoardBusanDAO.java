...
public class BoardBusanDAO {
	...
	// 게시글 목록을 가져오는 메서드
	public static ArrayList<BoardBean> getBusanBoardList(int page) throws Exception {
		// 데이터 베이스 접속
		Connection db = DBConn.getConnection();
		...
		String sql2 = "SELECT a.board_idx, a.board_subject,  a.board_read_cnt, a.board_area_code "
				...
				+ "FROM board_table_busan a WHERE a.board_area_code='부산' ORDER BY a.board_idx desc limit ?, ?";

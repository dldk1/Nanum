 ...
 */
@WebServlet("/NoticeBoardWriteProServlet")
public class NoticeBoardWriteProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeBoardWriteProServlet() {
        super();
...
//			board_bean.setBoard_info_idx(board_info_idx);
			...
			int board_idx = BoardNoticeDAO.addBoardContent(board_bean);
			System.out.println(board_idx);
			request.setAttribute("board_idx", board_idx);
			// 뷰로 이동한다.
			String site = "/admin/board_write_pro_notice.jsp";

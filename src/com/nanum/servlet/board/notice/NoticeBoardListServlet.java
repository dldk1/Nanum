 ...
 */
@WebServlet("/NoticeBoardListServlet")
public class NoticeBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// 전체 페이지수를 구한다.
			int page_cnt = BoardNoticeDAO.getPageCnt();
			...
			// 게시판 글 리스트를 가져온다.
			ArrayList<BoardBean> board_list = BoardNoticeDAO.getBoardList(page);
			request.setAttribute("board_list", board_list);

			String site = "/admin/board_list_notice.jsp";
